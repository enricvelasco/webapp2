...
var esUpdate = false
export class ListadoCategoriasLocal extends Component{
 ...
 _eliminarCampos =(e)=>{
   ...
   this.setState({
     ...
     db.collection("categoriasLocal").doc(this.state.camposGridSeleccionados[0].codigoLink.id).delete()
     .then(() => {
 ...
 render(){
   ...
   return(
         <div className="box margenes-box-listado">
           ...
           <div className="columns">
               <div>
                 <Link to='/categoriasLocal/new' className="button is-primary" onClick={((e) => this._cargarFormulario(e, 'nuevo', null))}>Nuevo</Link>
               </div>
               <div>
